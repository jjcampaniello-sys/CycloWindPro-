...
async function getAlternativeRoute(start, endLat, endLon) {
    ...
    const body = {
        ...
        // 🔥 CORRECTION CRITIQUE 1 : Utilisation du terme officiel "waytype" à la place de "roadattributes"
...
function calculateWindScore(latlngs, extras) {
    ...
    // 🔥 CORRECTION CRITIQUE 2 : Alignement sur le dictionnaire "waytype" renvoyé par ORS
    if (extras && extras.waytype && extras.waytype.values) {
        extras.waytype.values.forEach(item => {
            ...
            // Les index 1 (StateRoad) et 2 (Street) décrivent des zones denses et urbaines abritées par les façades
...
async function getRoute(){
    ...
    // 🔥 SÉCURISÉ ET ASSEMBLÉ : Injection correcte des "extras" d'obstacles
    ...
    // --- CONFIGURATION DE L'AFFICHAGE DYNAMIQUE (RETAURÉE) ---
...
// 🔥 LOGIQUE DU BOUTON DEMARRER (RESTAURÉE ET REFERMÉE)
