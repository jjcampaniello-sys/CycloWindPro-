...
async function getAlternativeRoute(start, endLat, endLon) {
    ...
    const body = {
        ...
        // 🔥 AJOUT SÉCURISÉ : Demande officielle des filtres d'obstacles à l'API
...
// 🔥 NOUVELLE FONCTION COMPATIBLE : Intègre la détection des arbres et des bâtiments
